...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen md:p-6 gap-12 overflow-hidden">
      <div className="mt-[450px] lg:mt-[500px]">
        <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
          ...
          <Link
            href="login"
            className="md:px-6 md:py-3 px-10 py-3 bg-transparent border-2 border-gradient-to-r from-blue-400 to-ourgreen text-white rounded-full text-sm md:text-base lg:text-lg font-bold relative md:overflow-hidden hover:scale-105 transition-transform duration-300"
          >
